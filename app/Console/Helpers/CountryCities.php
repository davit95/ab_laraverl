...
class CountryCities
{
	public function __construct()
	{
		...
		[
			'Algeria'        			=> ['Algiers'],
			'Australia'      			=> ['North Sydney', 'Brisbane', 'Perth', 'Sydney'],
			'Belgium'        			=> ['Brussels', 'Brussels Schuman', 'Gent', 'Kortrijk', 'Mechelen'],
			'Belize'         			=> ['Belize City'],
			'Brazil'         			=> ['Sao Paulo'],
			'Bulgaria'       			=> ['Sofia'],
			'Canada'         			=> ['Richmond Hill', 'Toronto', 'Vancouver'],
			'China'          			=> ['Beijing', 'Chengdu', 'Guangzhou', 'Macau', 'Shanghai', 'Shenzhen', 'Tianjian', 'Tianjin'],
			'Colombia'       			=> ['Bogota'],
			'Czech Republic' 			=> ['Prague'],
			'Finland'                   => ['Helsonki'],
			'France'         			=> ['Bordeaux', 'Forbach', 'Grenoble', 'Le Mans', 'Lille', 'Lyon', 'Montpellier', 'Nantes', 'Nice', 'Paris', 'Rennes', 'Roissy', 'Sophia Antipolis', 'Terssac', 'Toulouse'],
			'Germany'        			=> ['Berlin', 'Bielefeld', 'Bremen', 'Cologne', 'Darmstadt', 'Dortmund', 'Dusseldorf', 'Eschborn', 'Essen', 'Frankfurt', 'Freiburg', 'Hamburg', 'Hannover', 'Leipzig', 'Magdeburg', 'Mainz', 'Munich', 'Munster', 'Potsdam', 'Saarbrucken', 'Stuttgart', 'Wiesbaden'],
