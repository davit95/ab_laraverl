...
@section('content')
    ...
    <div class="TopCities">
        <div class="Wrapper">
            ...
            <ul>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'los-angeles'])!!}"><li>Los Angeles</li></a>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'new-york'])!!}"><li>New York</li></a>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'chicago'])!!}"><li>Chicago</li></a>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'dallas'])!!}"><li>Dallas</li></a>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'atlanta'])!!}"><li>Atlanta</li></a>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'houston'])!!}"><li>Houston</li></a>
                ...
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'DE', 'city_slug' => 'berlin'])!!}"><li>Berlin</li></a>
                ...
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'las-vegas'])!!}"><li>Las Vegas</li></a>
                <a href="{!! URL::action('VirtualOfficesController@getCityVirtualOffices', ['country_code' => 'US', 'city_slug' => 'washington'])!!}"><li>Washington</li></a>
            </ul>
        </div>
    </div>
    <div class="WhyUs">
