<div class="w_box view_box">
    ...
    <div class="form_right">
        ...
        <div class="line">
            ...
            <div class="formOinfo">{{ $owner->city }}</div>
        </div> 
        <div class="line">
        ...
        <div class="line">
            ...
            <div class="formOinfo">{{ $owner->us_state }}</div>
        </div> 
        <div class="line">
            <span class="lh_fi mediumBold">Country:</span>&nbsp;
            <div class="formOinfo">{{ $owner->country }}</div>
        </div> 
        <div class="line">
    ...
    <div class="bBox_btns">
        ...
        <div class="edit_oBtn bordL"><a href="{{ url('owners/'.$owner->id.'/edit') }}" class="gLink"><div class="sBox_icons edit_green"></div>Owner</a></div>
    </div> 
    <div class="clear"></div>
</div>
</div>