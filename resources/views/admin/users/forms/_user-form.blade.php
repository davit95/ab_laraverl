	...
	<div class="panel panel-default">
		<div class="panel-body col-md-6">
	    	...
	    	<div class="row form-group">
	    		...
	    		<div class="col-md-8">{!! Form::text('first_name', null, [ 'class' => 'form-control', 'placeholder' => 'user name' ]) !!}</div>
	    	</div>
	    	<div class="row form-group">
	    		<div class="col-md-4 text-right"><label>Create A Last Name</label></div>
	    		<div class="col-md-8">{!! Form::text('last_name', null, [ 'class' => 'form-control', 'placeholder' => 'user name' ]) !!}</div>
	    	</div>
	    	<div class="row form-group">
	    		<div class="col-md-4 text-right"><label>Create A Password</label></div>
	    		<div class="col-md-8">{!! Form::text('password', null, [ 'class' => 'form-control', 'placeholder' => 'user name' ]) !!}</div>
	    	</div>
	    </div>
	    <div class="panel-body col-md-6">
	    	<div class="row form-group">
	    	...
	    	<div class="row form-group">
	    		...
	    		<div class="col-md-8">{!! Form::text('phone', null, [ 'class' => 'form-control', 'placeholder' => 'Owner\'s Email' ]) !!}</div>
	    	</div>
	    	<div class="row form-group">
	    		<div class="col-md-4 text-right"><label>Address1:</label></div>
	    		<div class="col-md-8">{!! Form::text('address1', null, [ 'class' => 'form-control', 'placeholder' => 'Owner\'s Email' ]) !!}</div>
	    	</div>
	    	<div class="row form-group">
	    		<div class="col-md-4 text-right"><label>Address2:</label></div>
	    		<div class="col-md-8">{!! Form::text('address2', null, [ 'class' => 'form-control', 'placeholder' => 'Owner\'s Email' ]) !!}</div>
	    	</div>
	    	<div class="row form-group">
