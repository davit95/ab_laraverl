...
<body>
    ...
    <!-- jQuery -->
    <script src="/admin_assets/admin/bower_components/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/admin_assets/admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
