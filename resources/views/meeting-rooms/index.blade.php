...
@section('content')
    ...
    <div class="contactTop">Call: +1 888.869.9494</div><!--/contactTop-->
      ...
      <div class="productContWrap">
        ...
        <h1 class="mediumBold">Time to Talk Business:<br>Meeting Rooms for Every Agenda</h1>
        <p class="light">Book a meeting room online in your virtual office location, or in another listed business center of your choice. 
        Select your location from <span class="mediumBold">hundreds of meeting rooms worldwide</span>, choose your room size, add any special requests, 
        and leave the rest to us. Alliance Virtual Offices acts as your personal concierge, booking the room on your behalf.</p>
        <a class="popup-with-form popupForm" href="#test-form"><div class="inquiryBtn">INQUIRE ABOUT MEETING ROOMS</div></a>
        </div><!--/productTxtWrap-->
...
<div class="Bookings">
	<div class="productContWrap">
        ...
        <p>Book your meeting room online and receive an email confirmation within the hour*. 
        Select your location, venue and room size, enter your payment details into our secure portal, 
        and you're done. We'll confirm availability direct with the venue, confirm your 
        booking and send a confirmation email immediately.<br><span class="smallLine">*During business hours</span></p>
        <br><h1>Or Book By Phone</h1>
        <p>Phone your meeting room requirements through to us and we'll act as your private concierge. We'll source a suitable venue, 
        check availability and confirm your booking within the hour*. We'll also handle any changes or cancellations.<br><span class="smallLine">*During business hours</span></p>
        </div><!--/productTxtWrap-->
       </div><!--/productContWrap-->
</div><!--/Bookings-->
...
<div class="PBenefits">
	<div class="productContWrap">
        <div class="productTxtWrap">
        <h1>Benefits</h1>
        <p><span class="mediumBold">Meeting rooms in minutes:</span><br>
        Choose from thousands of meeting rooms in <span class="medium">hundreds of locations across the globe</span>. 
        By the hour, half or full day - the choice is yours. <br>Book online in minutes with our fast, secure system.<br><br>
        <span class="mediumBold">No more noisy coffee shops:</span><br>
        Isn't it time to upgrade your meeting venue?<br> Give your business the VIP experience it deserves, 
        without the luxury price tag. <br><span class="medium">From interview rooms to conference suites</span>, 
        budget-friendly to WOW-factor, book meeting rooms in every size, shape and city imaginable.<br><br>
        <span class="mediumBold">Clear pricing structure:</span><br>
        Renting a meeting room doesn't have to take up the lion's share of your budget. All of our meeting rooms are clearly and competitively priced, with a list of inclusive amenities too. A friendly greeting comes as standard, along with help and support from the Alliance Virtual Offices team.</p>
        </div><!--/productTxtWrap-->
       </div><!--/productContWrap-->
</div><!--/PBenefits-->
...
<div class="MR_Services">
	<div class="productContWrap">
        ...
        <p><span class="mediumBold">Full transparency:</span><br>
        Just like a hotel, facilities vary from room-to-room. <br>Rest assured full details of what's included will be clearly displayed on your chosen meeting room venue, prior to booking.<br><br>
        <span class="mediumBold">Friendly greeting:</span><br>
        Every venue is staffed by a professional management team who are ready and waiting to receive you and your guests. 
        Many venues also offer additional receptionist support such as admin or secretarial services.<br><br>
        <span class="mediumBold">We're here for you:</span><br>
        When you rent a meeting room through <span class="medium">Alliance Virtual Offices</span>, <br>we become <span class="medium">your personal concierge</span>. 
...
<div class="HowToBook">
	<div class="productContWrap">
        <div class="productTxtWrap">
        <h1>How to Book</h1>
        <p>Booking a meeting room through Alliance Virtual Offices couldn't be simpler. Get your calendar ready, 
        follow these few simple steps, et voila - you've booked your perfect meeting room! Here's how it works:<br><br>
        <span class="mediumBold">Step 1.</span> Find your preferred meeting venue.<br><br>

        <span class="mediumBold">Step 2.</span> Enter your date and time frame, choose your style of meeting room and capacity, choose additional services then click 'Submit'.<br><br>
         
        <span class="mediumBold">Step 3.</span>  Checkout<br><br>
         
        <span class="mediumBold">Step 4.</span> Your booking will be verified and payment processed*. You'll receive a room reservation and payment confirmation.<br><br>
