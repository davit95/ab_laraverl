...
@section('content')
	...
	<div class="TopCities">
    	<div class="Wrapper">
        	...
        	<ul>
            	<!-- <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'US', 'city_slug' => 'los-angeles', 'city_id' => '2173'])!!}"><li>Los Angeles</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'US', 'city_slug' => 'new-york', 'city_id' => '15275'])!!}"><li>New York</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'AU', 'city_slug' => 'sydney', 'city_id' => '25173'])!!}"><li>Sydney</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'US', 'city_slug' => 'dallas', 'city_id' => '21622'])!!}"><li>Dallas</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'AU', 'city_slug' => 'melbourne', 'city_id' => '25172'])!!}"><li>Melbourne</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'US', 'city_slug' => 'houston', 'city_id' => '21899'])!!}"><li>Houston</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'GB', 'city_slug' => 'london', 'city_id' => '25311'])!!}"><li>London</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'CN', 'city_slug' => 'beijing', 'city_id' => '25186'])!!}"><li>Beijing</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'JP', 'city_slug' => 'tokyo', 'city_id' => '25256'])!!}"><li>Tokyo</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'AE', 'city_slug' => 'dubai', 'city_id' => '25303'])!!}"><li>Dubai</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'BE', 'city_slug' => 'brussels', 'city_id' => '25175'])!!}"><li>Brussels</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'NL', 'city_slug' => 'amsterdam', 'city_id' => '25278'])!!}"><li>Amsterdam</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'FR', 'city_slug' => 'paris', 'city_id' => '25209'])!!}"><li>Paris</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'US', 'city_slug' => 'las-vegas', 'city_id' => '13791'])!!}"><li>Las Vegas</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'US', 'city_slug' => 'washington', 'city_id' => '3251'])!!}"><li>Washington</li></a>  -->
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['us_state_code' => 'CA', 'city_slug' => 'los-angeles'])!!}"><li>Los Angeles</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['us_state_code' => 'NY', 'city_slug' => 'new-york'])!!}"><li>New York</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'AU', 'city_slug' => 'sydney'])!!}"><li>Sydney</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['us_state_code' => 'TX', 'city_slug' => 'dallas'])!!}"><li>Dallas</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'AU', 'city_slug' => 'melbourne'])!!}"><li>Melbourne</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['us_state_code' => 'TX', 'city_slug' => 'houston'])!!}"><li>Houston</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'GB', 'city_slug' => 'london'])!!}"><li>London</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'CN', 'city_slug' => 'beijing'])!!}"><li>Beijing</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'JP', 'city_slug' => 'tokyo'])!!}"><li>Tokyo</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'AE', 'city_slug' => 'dubai'])!!}"><li>Dubai</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'BE', 'city_slug' => 'brussels'])!!}"><li>Brussels</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'NL', 'city_slug' => 'amsterdam'])!!}"><li>Amsterdam</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['country_code' => 'FR', 'city_slug' => 'paris'])!!}"><li>Paris</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['us_state_code' => 'NV', 'city_slug' => 'las-vegas'])!!}"><li>Las Vegas</li></a>
                <a href="{!! URL::action('MeetingRoomsController@getCityMeetingRooms', ['us_state_code' => 'DC', 'city_slug' => 'washington'])!!}"><li>Washington</li></a>
        	</ul>
    	</div>
	</div>
@stop
