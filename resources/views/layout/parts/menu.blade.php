<div class="headMenu">
    ...
    <div class="menu">
        <div class="btnMenu">
            <a class="@if(Request::is('virtual-offices*')) active @endif" href="{!! URL::action('VirtualOfficesController@index') !!}">VIRTUAL OFFICES</a>
        </div>
        <div class="btnMenu">
        ...
        <div class="btnMenu">
            <a href="{!! URL::action('Auth\AuthController@getLogin') !!}"><span class="light">Login</span></a>
        </div>
        <div class="btnMenu">
            <a class="@if(Request::is('contact*')) active @endif" href="{!! URL::action('AvoPagesController@contact') !!}"><span class="light">Contact</span></a>
        </div>
        <div class="btnMenu">
            <a class="@if(Request::is('cart*')) active @endif" href="{!! URL::action('CartController@index') !!}"><span class="orange">CART</span><img src="/images/cart-icon.png" class="cartIcon" border="0" width="23" height="23"></a>
        </div>
    </div>
</div>
