    ...
    <body>
        <div class="dPlansWrap2" style="padding-left:1%; padding-right:1%; box-sizing:border-box;-webkit-box-sizing: border-box; -moz-box-sizing: border-box;">
            <div class="dPlansAllWrap2">
                <div class="dPlansAll">
                    <div class="Plans">
                        <div class="topPlanGridL">
                            <a href="#" class="melon">
                                <span class="melon bold">{!! $center->bulding_name !!}</span>
                            </a>
                            <br>
                            {!! $center->address1!!} {!! $center->address2!!}
                        </div>
                        <div class="topPlanGridR">
                            <a href="$next_URL" class="link MoreInfoBtnMP">
                                <div class="btnMoreInfoP MoreInfoBtnMP">About This Center</div>
                            </a>
                        </div>
                    </div>
                    <div class="aPlan2a pmr">
                    	<div class="aPlanTop2a">
                            <div class="wrapPPa">
                                <div id="startPlan" class="PNLeft lh2 gray2">
                                    <h3 class="cf1">PLATINUM</h3>
                                </div>
                        ...
                        <a href="{{ url('/customize-mail?p=103&cid='.$center->id) }}" class="link planVo1" onclick="addToCart(103);">
                            <div class="btnSelectP2a planVo1">SELECT PLAN</div>
                        </a>
                    </div>
                    <div class="aPlan2a pmr goright mobilePlan2 bestPlan">
                        <div class="BestPlanTop">
                            <div class="GreatPlanTL">BEST DEAL</div>
                            <div class="GreatPlanTR">You save $10 a month</div>
                        </div>
                        <div class="aPlanTop2a">
                            <div class="wrapPPa">
                                <div class="PNLeft2 gray2">
                                    <h3 class="cf1">
                                        PLATINUM
                                        <br>
                        ...
                        <a href="{{ url('/customize-mail?p=103&b=402&cid='.$center->id) }}" class="link planVo1" onclick="addToCart(103);">
                            <div class="btnSelectP2a planVo1">SELECT PLAN</div>
                        </a>
                    </div>
                    <div class="aPlan2a pmr mobilePlan">
                        ...
                        <a href="{{ url('/customize-mail?p=105&cid='.$center->id) }}" class="link planVo1" onclick="addToCart(103);">
                            <div class="btnSelectP2a planVo1">SELECT PLAN</div>
                        </a>
                    </div>
                    <div class="aPlan2a pmr goright mobilePlan greatPlan">
                        <div class="GreatPlanTop">
                            <div class="GreatPlanTL">GREAT DEAL</div>
                            <div class="GreatPlanTR">You save $10 a month</div>
                        </div>
                        <div class="aPlanTop2a">
                            <div class="wrapPPa">
                        ...
                        <a href="{{ url('/customize-mail?p=105&b=402&cid='.$center->id) }}" class="link planVo1" onclick="addToCart(103);">
                            <div class="btnSelectP2a planVo1">SELECT PLAN</div>
                        </a>
                    </div>
                </div>
        ...
        <div class="extras2 gray3" style="padding-left:1%; padding-right:1%; box-sizing:border-box;-webkit-box-sizing: border-box; -moz-box-sizing: border-box;">
            <p>
        ...
        <div class="expl2 gray3" style="padding-left:1%; padding-right:1%; box-sizing:border-box;-webkit-box-sizing: border-box; -moz-box-sizing: border-box;">
