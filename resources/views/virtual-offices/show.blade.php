						...
						<div class="aPlan2">
						    ...
						    <div class="secondline gray3">
						    	@if(isset($packages['Platinum'])  && $packages['Platinum']->current_currency_price->price)
						    		<span class="price">&nbsp;{!! session('currency.symbol') !!}{!! $packages['Platinum']->current_currency_price->price !!}</span><span class="pMonth"> /MONTH</span><br><p class="save">{!! session('currency.symbol') !!}{!! 100*session('rate') !!} Set up fee</p>
						    	@else
								    ...
								    <div class="firstline gray2"><h3 class="cf1">&nbsp; PLATINUM<a href="#" title=""> <img src="/images/info.png" class="tooltip2"/></a><br><span class="smallLine">WITH LIVE RECEPTIONIST</span></h3></div>
									    <div class="secondline gray3">
										    @if(isset($packages['Platinum'])  && $packages['Platinum']->current_currency_price->price)
											    ...
											    <br>
											    <p class="save">
											    	<span class="orange mediumBold">You save {!! session('currency.symbol') !!}10</span> &nbsp; {!! session('currency.symbol') !!}{!! 100*session('rate') !!} Set up fee
											    </p>
											@else
												<span class="price"></span><br><p class="">Not Available</p><div class="btnSpace"></div>
										   	@endif
						...
						<div class="aPlan2 mobilePlan">
						    ...
						    <div class="secondline gray3">
						    	@if(isset($packages['Platinum Plus']) && $packages['Platinum Plus']->current_currency_price->price)
						    		<span class="price">&nbsp;{!! session('currency.symbol') !!}{!! $packages['Platinum Plus']->current_currency_price->price !!}</span><span class="pMonth"> /MONTH</span><br><p class="save">{!! session('currency.symbol') !!}{!! 100*session('rate') !!} Set up fee</p>
						    	@else
						    		<span class="price"></span><br><p class="">Not Available</p><div class="btnSpace"></div>
						    	@endif
						    </div>
